...
API_KEY = 'AIzaSyBMqnQ_XnrEr61eVcimrftpVXOM0exULPY'
...
TABLE_ID = '17KMPZ-fVnLtF4exgo12p65NOpK_DM8rRkGpiWV1h'

# This is the default columns for the query
query_cols = []
query_values = ['1'] #Change to be the value(s) you're querying in the column you've specified
...
def get_all_data(query):
    ...
    #query = "SELECT * FROM " + TABLE_ID + " WHERE  Survived = '1' LIMIT 10"
...
def make_query(cols, values, limit):
    ...
    query = "SELECT " + string_cols + " FROM " + TABLE_ID + " WHERE Survived = '" + string_values + "'"
